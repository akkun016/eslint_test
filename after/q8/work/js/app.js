  ...
  function displayResult(result) {
    ...
    // それ以外であれば
      ...
      $.each(resultItemsAry, function(index, item){
        ...
        const itemTitle = item['title'] === undefined ?
          'タイトル不明' :
          item['title'];
        const itemCreator = item['dc:creator'] === undefined ?
          '作者不明' :
          item['dc:creator'];
        const itemPublisher = item['dc:publisher'] === undefined ?
          '出版社不明' :
          item['dc:publisher'];
